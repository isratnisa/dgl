...
__all__ = ['reshape', 'gsddmm', 'copy_u', 'copy_v', 'copy_e']
...
def gsddmm(g, op, lhs_data_dict, rhs_data_dict, lhs_target='u', rhs_target='v'):
    ...
    return gsddmm_internal(
        g, op, lhs_data_dict, rhs_data_dict, lhs_target, rhs_target)
